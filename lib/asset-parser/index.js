...
function parseAssetBundle(data) {
	...
	asset.objects.forEach((object, index) => {
		var internal_type_id = object.type_id;
		var internal_class_id = object.class_id;
		...
		var objectBuffer = Buffer.from(bundle.assets.slice(assetHeader.data_offset + object.data_offset, assetHeader.data_offset + object.data_offset + object.size));
